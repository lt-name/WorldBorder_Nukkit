...
public class WindowCreate {
    ...
    public static void sendAdminMenu(Player player) {
        ...
        simple.addButton(new ElementButton("§e删除当前世界设置", new ElementButtonImageData("path", "textures/ui/redX1")));
        simple.addButton(new ElementButton("§e保存缓存并重载配置", new ElementButtonImageData("path", "textures/ui/refresh_light")));
